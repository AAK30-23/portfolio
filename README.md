...
**ООО «АЙТИ РЕЗЮМЕ» / Simulative** (2025–2026)  
Курс [`«Аналитик данных»`](https://simulative.ru/data-analyst)
...
- Расчет и интерпретация продуктовых метрик: LTV, CAC, Retention, ROMI, DAU/MAU и др
- Когортный анализ, RFM- и ABC/XYZ-сегментация
- Проведение и оценка A/B-тестов: понимание t, Z, U-тестов, p-value, доверительных интервалов
- Базовые знания машинного обучения: типы задач, этапы создания ML-модели, основные алгоритмы

**Инструменты визуализации и отчетности**
- **Power BI:** создание интерактивных дашбордов с использованием Power Query и DAX
- **Excel:** продвинутые формулы, сводные таблицы, диаграммы, условное форматирование
- Опыт работы с **Yandex DataLens**, **Superset**, **Metabase**

**SQL и Python**
- **SQL (PostgreSQL):** сложные запросы — JOIN, подзапросы, оконные функции, CTE
- **Python:** Pandas, NumPy — обработка и анализ данных; Matplotlib, Plotly — визуализация

**Работа с данными и моделирование**
- Понимание ETL/ELT-процессов и принципов построения витрин данных под бизнес-задачи
- Моделирование данных: ER-диаграммы, BPMN, UML
...
### Хакатон Hack & Change by Changellenge (2025) [`Диплом`](https://github.com/AAK30-23/portfolio/blob/main/assets/HackChange_diploma.pdf)
**Трек:** ML/Web — построение модели прогноза дохода для **Альфа-Банка**
